  ...
  return (
    <ScrollView>
      <View className="px-6 py-12">
        <View className="mb-6">
          <Text className="text-2xl mb-2 font-bold">POLÍTICAS DE PRIVACIDAD</Text>

          <Text className="text-lg">
            El presente Política de Privacidad establece los términos en que
            Torneopalooza usa y protege la información que es proporcionada por sus
        ...
        <View className="mb-6">
          <Text className="text-xl mb-2 font-bold">Información que es recogida</Text>
        ...
        <View className="mb-6">
          ...
          <Text className="text-lg">
            ...
            Torneopalooza está altamente comprometido para cumplir con el
        ...
        <View className="mb-6">
          <Text className="text-xl mb-2 font-bold">Cookies</Text>
          ...
          <Text className="text-lg">
            ...
            usted así lo quiera y la proporcione directamente noticias. Usted
        ...
        <View className="mb-6">
          <Text className="text-xl mb-2 font-bold">Enlaces a Terceros</Text>
        ...
        <View className="mb-6">
          ...
          <Text className="text-lg">
            ...
            judicial. Torneopalooza Se reserva el derecho de cambiar los términos
